...
class Character:
    ...
    hide_day: int = 0
    # ความล้าสะสม 0..1 และสัดส่วนปริมาตรเลือดเทียบระดับปกติ (ดู body/circulation.py)
    # เป็นสภาพที่เปลี่ยนตลอดเวลา จึงต้องเก็บจริงเหมือนบาดเจ็บ — แต่เป็นแค่ทศนิยมสองตัว
    fatigue: float = 0.0
    blood_frac: float = 1.0
    # อัตราเลือดออกตอนนี้ (สัดส่วนปริมาตรปกติต่อวัน) — เป็น *สถานะ* ไม่ใช่ค่าที่คำนวณสด
